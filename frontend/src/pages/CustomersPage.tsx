          ...
          <DataTable
            columns={[
              ...
              },
              {
                key: "business",
                header: "Business",
                render: (c) => <span>{c.businessName}</span>,
              },
              {
                key: "type",
                header: "Type",
                render: (c) => <span>{c.customerType}</span>,
              },
              {
                key: "mobile",
                header: "Mobile",
                render: (c) => <span>{c.mobile}</span>,
              },
              {
                key: "status",
                header: "Status",
              ...
              },
              {
                key: "follow",
                header: "Follow-up",
                render: (c) => <span>{formatDate(c.followUpDate)}</span>,
              },
            ]}
            data={items}
...
export function CustomerEditPage() {
  ...
  async function submit(e: FormEvent) {
    ...
    if (!id) {
      notify("Customer ID is missing", "error");
      return;
    }
  ...
  if (!id) {
    return <p>Customer ID is missing.</p>;
  }
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap justify-between gap-3">
        <div>
          <Link className="text-sm text-teal-700" to="/customers">
            ← Customers
          </Link>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Info
          ...
          value={formatDate(c.followUpDate)}
        />
      </div>
  ...
  return (
    <form onSubmit={submit} className="max-w-4xl space-y-5">
      <div>
        ...
        <p className="text-sm text-slate-500">
          Capture the CRM record and next follow-up.
        </p>
      </div>
      ...
      <div className="grid gap-4 rounded-2xl border bg-white p-5 shadow-sm sm:grid-cols-2">
        {(
          ...
          <FormInput
            ...
            required={
              !["gstNumber", "followUpDate", "notes"].includes(key)
            }
          />
        ))}
